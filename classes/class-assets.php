...
class Assets {
	...
	protected function setup_hooks() {
		...
		*/
		...
		add_action( 'elementor/editor/after_enqueue_scripts', array( $this, 'usc_elementor_script' ) );
	}
	...
	public function register_styles() {
		...
		wp_enqueue_style( 'main-css', NM_DIR_URI . '/assets/css/style.css', array(), filemtime( NM_DIR_PATH . '/assets/css/style.css' ), 'all' );
		wp_enqueue_style( 'stylesheet', NM_STYLE_URI, array(), filemtime( NM_DIR_PATH . '/style.css' ), 'all' );
	}
	...
	public function usc_elementor_script() {
		wp_register_script( 'usc-script-owl', 'https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js' );

		wp_enqueue_script( 'usc-script-owl' );
	}
}
